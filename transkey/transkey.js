...
function initTranskey(name){
	//setMaxDigits(131);	
	transkey.objs= new Array();
	tk = new Transkey(name);
...
function TranskeyObj(id){
	this.isMultiCursor = true;
	this.isMultiMode=false;
	this.allocate=false;
	if (id) {
		this.id="ibxIdnNo_tk_input";
		this.name="ibxIdnNo_tk_input";
	} else {
		this.id="ssn2";
		this.name="ssn2";
	}
...
//	};
	...
	function getUrl(op, o, keyType){
		...
		+o.fieldType+"&inputName="+o.name+"&transkeyUuid="+tk.transkeyUuid+"&TK_requestToken="+tk.TK_requestToken+"&"+new GenKey().tk_getrnd_int();
	}
...
function Transkey(bankNm){
	...
	var cert_pub;
	if (bankNm == 'bankhf') 
		cert_pub = "-----BEGIN CERTIFICATE----------END CERTIFICATE-----";
	else
		cert_pub = "-----BEGIN CERTIFICATE----------END CERTIFICATE-----";
...
//							res = ( new Function( Key+node.childNodes[j].nodeValue.replace("//", "") +'return [qwerty,number]' ) )();
//						}
//					}
//				}
//				mKey["qwerty"] = res[0];
...
//	};
//	
	this.fillEncData = function(ssn2_encrypted)
	{
		var valueLen = 7;
		...
		log("fillEncData ssn2_encrypted : " + ssn2_encrypted);
		log("fillEncData hm_ssn2_encrypted : " + hm_ssn2_encrypted);

		var sshObj = {};
		sshObj.ssn2_encrypted    = ssn2_encrypted;
